...
function Review() {
  ...
  // Helper function to check and wrap around the index boundaries
  ...
  const randomReview = () => {
    ...
    // Force a new index if it happens to match the current one
  ...
  return (
    <article className="review">
      ...
      {/* Required special id attribute structure formatting (e.g. author-1, author-2) */}
